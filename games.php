...
//try {
    ...
    //check for search keywords
        ...
        if(!empty($_GET['keywords'])){
            ...
            //this will check for OR / AND in the searcg type dropdown
...
echo '<div class="fb-comments" data-href="http://gc200289922.computerstudi.es/comp1006/lesson12/games.php" data-numposts="5"></div>';
